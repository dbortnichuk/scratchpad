...
package dbstrategy3 {
  ...
  import edu.dbortnichuk.akka.aia.ch4.dbstrategy1.DbNodeDownException
  ...
  class LogProcSupervisor(dbSupervisorProps: Props)
    ...
    //<co id="ch03-dbsupervisor-create"/>
